  ...
  return (
    <section id="Contact" className={styleConfig.container} ref={containerRef}>
      <div className={`${styleConfig.textWrapper} contact-item`}>
        <Title Label="Need a Website or Custom System?" Type="Bold" />
        <Title
          Label="Let’s discuss how we can build a modern website, dashboard, or digital system that fits your business needs clean, scalable, and easy to maintain."
          Type="subTitle"
        />
      </div>
